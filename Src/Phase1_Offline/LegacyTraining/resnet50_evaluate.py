...
from Src.Shared.Utils.utils_function import get_device, get_test_data_loaders
...
from Src.Shared.Config.paths import DATA_ROOT
...
def main():
    ...
    model_path = MODEL_PATHS.resolve_weight_path()
