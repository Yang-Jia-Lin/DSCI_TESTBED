...
from Scripts.Exp4_Convergency_and_Overhead.plot_convergency import (
    plot_convergence,
    plot_entropy,
    plot_lan_and_acc,
)
from Src.Shared.Config.paths import RESULT_CONVERGENCE_PATH, RESULT_DIR


def run_convergence_analysis(
    data_dir: Path, output_dir: Path = RESULT_CONVERGENCE_PATH
):
    # 数据
...
if __name__ == "__main__":
    data_path = RESULT_DIR / "Optimize" / "PPO" / "PPO_20260128_232731"
    run_convergence_analysis(data_path, RESULT_CONVERGENCE_PATH)
